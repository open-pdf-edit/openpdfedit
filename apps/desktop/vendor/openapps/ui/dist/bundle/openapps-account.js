import{d as u,e as b,f}from"./chunk-WUUXWBJ2.js";import{a as k,b as i,d as o,e as w,g as l,h as m,i as g,j as p}from"./chunk-ISCWIPSM.js";import{a as r}from"./chunk-LCQWCHVU.js";var v={google:"Google",eip155:"Wallet",nostr:"Nostr"},a=class extends p{constructor(){super(...arguments);this.me=null;this.enabled=null;this.pending=null;this.notice=null;this.blocked=null}connectedCallback(){super.connectedCallback(),this.load()}onSessionChange(){this.load()}async load(){if(await Promise.resolve(),this.handleLinkRedirect(),this.enabled||(this.enabled=await this.run(()=>this.sdk.auth.methods())??null),!this.sdk.isLoggedIn){this.me=null;return}this.me=await this.run(()=>this.sdk.auth.me())??null}linked(e){return(this.me?.linked_accounts??[]).some(t=>t.namespace===e)}get connectable(){return["eip155","nostr"].filter(e=>this.enabled?.[e]&&!this.linked(e))}get canConnectGoogle(){return(this.enabled?.google??!1)&&!this.linked("google")}async connectGoogle(e=!1){await this.run(async()=>{let t=`${location.origin}${location.pathname}${location.search}`,s=await this.sdk.auth.googleLinkStart(t,{merge:e});window.location.href=s})}handleLinkRedirect(){let e;try{e=this.sdk.auth.completeLinkRedirect()}catch{return}if(e)switch(e.status){case"linked":this.notice=e.merged?`Accounts combined \u2014 ${e.credits.toLocaleString()} credits moved across.`:"Google connected.",this.emit("openapps-identity-linked",e),g();break;case"conflict":this.pending={namespace:"google",other:{id:"",balance:e.balance}};break;case"blocked":this.blocked=e.message;break;case"error":this.error=e.message;break}}async connect(e){this.blocked=null,await this.run(async()=>{let t=e==="eip155"?await u():void 0,s=await this.sdk.auth.linkChallenge(e,t),h=e==="eip155"?await b(s.message,t):await f(s.message);try{let n=await this.sdk.auth.linkVerify(s.challenge_id,h);this.afterLink(n)}catch(n){if(n instanceof m&&(n.detail?.code==="merge_blocked_by_duplicate_namespace"||n.detail?.code==="namespace_already_linked")){this.blocked=n.message;return}if(n instanceof m&&n.detail?.code==="identity_belongs_to_another_account"){this.pending={namespace:e,other:n.detail.other_account};return}throw n}})}async confirmMerge(){let e=this.pending;if(e){if(e.namespace==="google"){this.pending=null,await this.connectGoogle(!0);return}await this.run(async()=>{let t=e.namespace==="eip155"?await u():void 0,s=await this.sdk.auth.linkChallenge(e.namespace,t),h=e.namespace==="eip155"?await b(s.message,t):await f(s.message),n=await this.sdk.auth.linkVerify(s.challenge_id,h,{merge:!0});this.pending=null,this.afterLink(n)})}}afterLink(e){this.notice=e.merged?`Accounts combined \u2014 ${(e.credits_transferred??0).toLocaleString()} credits moved across.`:"Connected.",this.emit("openapps-identity-linked",e),g(),this.load()}async unlink(e){await this.run(async()=>{await this.sdk.auth.unlink(e),this.notice="Disconnected.",this.emit("openapps-identity-unlinked",{caip10:e}),await this.load()})}render(){if(!this.sdkOrNull)return i`<p class="muted">Loading…</p>`;if(!this.sdk.isLoggedIn)return i`<p class="muted">Sign in to manage your account.</p>`;if(!this.me)return i`<p class="muted">Loading…</p>`;if(this.pending)return this.renderMergePrompt(this.pending);let e=this.me.linked_accounts;return i`
      <div class="card">
        <div class="head">
          <div>
    ...
    `],r([l()],a.prototype,"me",2),r([l()],a.prototype,"enabled",2),r([l()],a.prototype,"pending",2),r([l()],a.prototype,"notice",2),r([l()],a.prototype,"blocked",2),a=r([w("openapps-account")],a);function y(d,c=18,e=8){return d.length<=c+e+1?d:`${d.slice(0,c)}\u2026${d.slice(-e)}`}export{a as OpenAppsAccount};
