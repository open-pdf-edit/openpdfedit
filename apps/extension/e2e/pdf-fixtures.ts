...
/** The same one-page text document as `TEXT_PDF_BASE64`, but protected
 * with the AES-256 (V5/R6) Standard Security Handler under the password
 * `"hunter2"` — the fixture behind ui-flows.spec.ts's password-prompt
 * leg, which is the one place the browser build's protected-open path is
 * exercised end to end.
 *
 * Generated the same way the two fixtures above were: a throwaway
 * `#[test]` in `openpdfedit-session` calling
 * `openpdfedit_crypt::encrypt_document(text_page_pdf_bytes("protected
 * contents", 72.0, 700.0, 24.0), "hunter2", "hunter2",
 * Permissions::default())` and writing the result out, then base64'd.
 * The test was removed before committing.
 *
 * Note this must stay a *real* encrypted document rather than a stub:
 * what it proves is that `is_encrypted` recognises it, that PDFium
 * refuses it undecrypted, and that the crypt crate's own decryption
 * produces something PDFium will then render — none of which a
 * hand-faked `/Encrypt` dictionary would exercise. */
export const ENCRYPTED_PDF_BASE64 =
  "";

// A one-page PDF whose markup has already been flattened into the page:
// "THE DOCUMENT" as a real text run, plus a transparent image (`/SMask`)
// drawn across the whole page standing in for a layer of pen strokes.
// There is no annotation anywhere in it — which is the point. This is
// the shape every tablet note-taker and scanner app exports, and the
// reason `removeMarkup` has to look at page content and not only at
// `/Annots`. Generated the same way as the fixtures above, from
// `openpdfedit-unmark`'s own test fixture builder.
export const MARKED_UP_PDF_BASE64 =
  "";
